...
import com.example.techpythons2023.HodrequestdetailsActivity;
...
public class HodRequestsAdapter extends RecyclerView.Adapter<HodRequestsAdapter.ViewHolder> {

    Context context;
    ArrayList<TarequestItem> moduleItemItemArrayList;
    DatabaseReference databaseReference;
    public HodRequestsAdapter(Context context, ArrayList<TarequestItem> moduleItemItemArrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.hodrequest_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.reqdetailbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, HodrequestdetailsActivity.class);
