...
import com.example.techpythons2023.Model.HodappsAdapter;
...
public class HodappsActivity extends AppCompatActivity {
    ...
    HodappsAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hodapps);
    ...
    private void readData() {
        ...
        databaseReference.child("Applications").orderByChild("Applimark").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new HodappsAdapter(HodappsActivity.this, moduleItemArrayList);
