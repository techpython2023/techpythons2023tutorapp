...
public class ModulesActivity extends AppCompatActivity {
    ...
    ModulesRecyclerAdapter adapter;
    Button addmodbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addmodbtn.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent i = new Intent(ModulesActivity.this, AddModuleActivity.class);
                startActivity(i);
            }
        });
    ...
    private void readData() {
        ...
        databaseReference.child("Modules").orderByChild("Modname").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ModulesRecyclerAdapter(ModulesActivity.this, moduleItemArrayList);
